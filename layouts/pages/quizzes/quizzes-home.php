...
<main class="main-container">
    ...
    <div class="search">
        <img class="header-links-img" src="../../../public/images/badges/bookmarkCollector.png">
        ...
        <ul class="category-list">
            <li class="category-item">
                <a href="quizzes-general-knowledge.php?category=film_and_tv">
                    <div class="category-image">
                        <img src="../../../public/images/users/52/The-Philadelphia-Story-009.webp" alt="Film & TV">
                    </div>
            ...
            <li class="category-item">
                <a href="quizzes-general-knowledge.php?category=history">
                    <div class="category-image">
                        <img src="../../../public/images/users/52/Napoleon.jpg" alt="History">
                    </div>
            ...
            <li class="category-item">
                <a href="quizzes-general-knowledge.php?category=literature">
                    <div class="category-image">
                        <img src="../../../public/images/users/52/shakespeare.jpg" alt="Literature">
                    </div>
            ...
            <li class="category-item">
                <a href="quizzes-general-knowledge.php?category=geography">
                    <div class="category-image">
                        <img src="../../../public/images/users/52/geography.jpg" alt="Geography">
                    </div>
            ...
            <li class="category-item">
                <a href="quizzes-general-knowledge.php?category=science">
                    <div class="category-image">
                        <img src="../../../public/images/users/52/science.jpg" alt="Science">
                    </div>
