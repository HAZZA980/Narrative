...
$query = "SELECT b.id, b.title, LEFT(b.content, 100) AS summary, b.datePublished, b.Tags, b.Image 
          FROM tbl_blogs b
        ...
        <div class="flex-container">
            ...
            <?php if ($blogs_result->num_rows > 0): ?>
                ...
                <div class="flex-item">
                    ...
                    <a href="<?php echo BASE_URL ?>layouts/pages/articles/article.php?id=<?php echo $row['id']; ?>" class="article-main-link">
                        <div class="blog-body">
                    ...
                    <div class="blog-details-2">
                        ...
                        <div class="likes-and-comments" data-article-id="<?php echo $row['id']; ?>">
                            ...
                            <div class="bookmark">
                                ...
                                <form action="bookmark.php" method="POST" class="bookmark-form">
                                    <input type="hidden" name="article_id" value="<?php echo $article_id; ?>">
                                    <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
