...
include BASE_PATH . 'includes/model/feed-logic.php';
            ...
            <div class="pagination">
                <?php if ($total_pages > 1): ?>
                    ...
                    <?php if ($current_page > 1): ?>
                        <a href="?username=<?php echo urlencode($username); ?>&page=<?php echo $current_page - 1; ?>" aria-label="Previous Page">Previous</a>
                    <?php endif; ?>

                    <!-- First Page -->
                    <a href="?username=<?php echo urlencode($username); ?>&page=1"
                    ...
                    <!-- Last Page -->
                    <?php if ($total_pages > 1): ?>
                        <a href="?username=<?php echo urlencode($username); ?>&page=<?php echo $total_pages; ?>"
                    ...
                    <?php if ($current_page < $total_pages): ?>
                        <a href="?username=<?php echo urlencode($username); ?>&page=<?php echo $current_page + 1; ?>" aria-label="Next Page">Next</a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
