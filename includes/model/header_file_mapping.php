...
$categories = [
    ...
    "Health and Fitness" => ["file" => "health.php", "image" => "public/images/header-icons/healthcare.png"],
    "History and Culture" => ["file" => "history-and-culture.php", "image" => "public/images/header-icons/history.png"],
