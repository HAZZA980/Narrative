...
<main class="main-container">
    <div class="main-content">
        <h1 class="main-content-title">Business</h1>

        <div class="grid-container">
            <h6>Add articles about other big companies. Banks, Car firms, etc </h6>
            <?php
            try {
        ...
        <h4 class="main-content-title">Big Tech</h4>
        ...
        <div class="grid-container">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="grid-item <?php echo $i; ?>">
                    ...
                    <div class="blog-details-2">
                        <p id="blog-tags">
                            <a href="business.php">Big Tech</a>
                        </p>
                        <p id="blog-date"><small><?php echo date('F j, Y', strtotime($row['datePublished'])); ?></small></p>
                    </div>
                </div>
