...
<head>
    ...
    <title>Technology | Narrative</title>
</head>
<body>
...
<main class="main-container">
    ...
    <div class="featured-author-section"> <!-- Added a parent div with a specific class -->
        <h4 class="main-content-title featured-author">Staff Picks</h4>

        <?php include BASE_PATH . "features/carousel/carouselTech.php"; ?>
    </div>



    <div class="main-content">
        <h4 class="main-content-title">Network Security</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%Network Security%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 10";
        ...
        <div class="latest-container">
            ...
            FROM tbl_blogs WHERE Private = '0' AND Category = 'Technology'
            ORDER BY DatePublished DESC";
            $result = $conn->query($sql);
