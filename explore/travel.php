...
<main class="main-container">
    ...
    <div class="featured-author-section"> <!-- Added a parent div with a specific class -->
        <h4 class="main-content-title featured-author">Travel Series of the Week: Harry's Workaway Experience</h4>

        <?php include BASE_PATH . "features/carousel/carouselTravel.php"; ?>
    </div>


    <div class="main-content">
        <h4 class="main-content-title">Erasmus Year Travel</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%Erasmus Year%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 10";
        ...
        <div class="latest-container">
            ...
            FROM tbl_blogs WHERE Private = '0' AND Category = 'Travel'
            ORDER BY DatePublished DESC";
            $result = $conn->query($sql);
