...
<main class="main-container">
    ...
    <div class="main-content">
        <h4 class="main-content-title">PC Gaming</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%PC Gaming%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 12";
        ...
        <div class="latest-container">
            ...
            FROM tbl_blogs WHERE Private = '0' AND Category = 'Gaming'
            ORDER BY DatePublished DESC";
            $result = $conn->query($sql);
        ...
        <div class="elsewhere-section">
            ...
            <h5 class="main-content-title">Technology</h5>
            ...
            <div class="grid-container">
                <?php
                $sql = "SELECT id, title, LEFT(content, 200) AS summary, datePublished, Tags, featured, Image, user_id 
                        FROM tbl_blogs WHERE Private = 0 AND Category = 'Lifestyle' ORDER BY RAND() LIMIT 10";
                $result = $conn->query($sql);
