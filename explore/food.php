...
<main class="main-container">
    ...
    <div class="main-content">
        <h4 class="main-content-title">Meals for the Family</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%Family Meal Plans%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 12";
        ...
        <div class="elsewhere-section">
            ...
            <div class="grid-container">
                ...
                $sql = "SELECT id, title, LEFT(content, 200) AS summary, datePublished, Tags, featured, Image, user_id 
                        FROM tbl_blogs WHERE Private = 0 AND Category = 'Lifestyle' LIMIT 10";
                $result = $conn->query($sql);
