...
<main class="main-container">
    <div class="main-content">
        <h1 class="main-content-title">Modern History</h1>

        <div class="grid-container">
            <?php
            try {
                // Get the current file name dynamically
                $sql = "SELECT id, title, LEFT(content, 250) AS summary, datePublished, Tags, featured, Image, user_id FROM tbl_blogs WHERE Tags = 'Modern History'";
        ...
        <h4 class="main-content-title">Greek Mythology</h4>

        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 250) AS summary, datePublished, Tags, featured, Image, user_id FROM tbl_blogs WHERE Tags = 'Greek Mythology'";
            $result = $conn->query($sql);
