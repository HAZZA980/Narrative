...
<main class="main-container">
    <div class="main-content">
        <h1 class="main-content-title">Writing Craft</h1>

        <div class="grid-container">
            <?php
            try {
                // Get the current file name dynamically
                $sql = "SELECT id, title, LEFT(content, 250) AS summary, datePublished, Tags, featured, Image, user_id FROM tbl_blogs WHERE Tags = 'Writing Craft'";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="grid-item p<?php echo $i; ?>">
                        ...
                        <div class="blog-details-2">
                            <p id="blog-tags">
                                <a href="writing-craft.php">
                                    <?php echo htmlspecialchars($row['Tags']); ?>
                                </a>
                            </p>
                            <p id="blog-date">
                                <small><?php echo date('F j, Y', strtotime($row['datePublished'])); ?></small></p>
                        </div>
                    </div>
                    <?php
        ...
        <h4 class="main-content-title">Featured Series: Story Planning</h4>
