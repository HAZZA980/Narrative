...
<main class="main-container">
    ...
    <div class="main-content">
        <h4 class="main-content-title">Now, that's Science</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%Biology%' or Tags like '%Chemistry%' or Tags like '%Physics%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 12";
        ...
        <div class="latest-container">
            ...
            FROM tbl_blogs WHERE Private = '0' AND Category = 'Science'
            ORDER BY DatePublished DESC";
            $result = $conn->query($sql);
