...
<head>
    ...
    <title>History & Culture | Narrative</title>
</head>
<body>
...
<main class="main-container">
    ...
    <div class="main-content">
        <h4 class="main-content-title">World War II</h4>
        <div class="grid-container">
            <?php
            $sql = "SELECT id, title, LEFT(content, 270) AS summary, datePublished, Tags, Image, user_id 
                    FROM tbl_blogs 
                    WHERE Tags like '%World War II%' 
                      AND featured = 0 
                      AND Private = 0
                    ORDER BY datePublished DESC 
                    LIMIT 12";
        ...
        <div class="latest-container">
            ...
            FROM tbl_blogs WHERE Private = '0' AND Category = 'History and Culture'
            ORDER BY DatePublished DESC";
            $result = $conn->query($sql);
        ...
        <div class="elsewhere-section">
            ...
            <h5 class="main-content-title">Business</h5>
            ...
            <div class="grid-container">
                <?php
                $sql = "SELECT id, title, LEFT(content, 200) AS summary, datePublished, Tags, featured, Image, user_id FROM tbl_blogs WHERE Private = 0 AND Category = 'Technology' LIMIT 10";
                $result = $conn->query($sql);
